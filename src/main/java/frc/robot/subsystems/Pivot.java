...
//         SmartDashboard.putNumber("Left Pivot Output 2", leftPivotMotor.getAppliedOutput());
//         SmartDashboard.putNumber("Right Pivot Output 2", rightPivotMotor.getAppliedOutput());
//         SmartDashboard.putNumber("Current Pivot Positon 2", getMeasurement());
//         SmartDashboard.putNumber("PID Pivot Position Radians 2", getRadians());
//         SmartDashboard.putNumber("Pivot Positon Degrees 2", getDegrees());
//         SmartDashboard.putNumber("Pivot Positon Encoder Position 2", getCorrectedEncounterTicks());
