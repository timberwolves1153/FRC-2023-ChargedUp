...
public class LeftScore2AndBalance extends PPAutoBase{

    public LeftScore2AndBalance(Swerve swerve, Collector collector, PIDExtender pidExtender, PIDPivot pidPivot) {
        super(swerve);

        PathPlannerTrajectory Score2andBalanceLeft = PathPlanner.loadPath("Score2AndBalanceLeft", new PathConstraints(2.0, 2.0));
        ...
        FollowPathWithEvents command = new FollowPathWithEvents(followTrajectoryCommand(Score2andBalanceLeft, true), Score2andBalanceLeft.getMarkers(), eventMap);
