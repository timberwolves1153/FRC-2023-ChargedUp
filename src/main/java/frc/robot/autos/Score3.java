...
public class Score3 extends PPAutoBase{

    public Score3(Swerve swerve, Collector collector, PIDExtender pidExtender, PIDPivot pidPivot) {
        super(swerve);

        PathPlannerTrajectory Score3 = PathPlanner.loadPath("Score3", new PathConstraints(2.0, 2.0));
        ...
        FollowPathWithEvents command = new FollowPathWithEvents(followTrajectoryCommand(Score3, true), Score3.getMarkers(), eventMap);
