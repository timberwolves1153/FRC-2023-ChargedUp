...
public class Score2AndBalance extends PPAutoBase{
    ...
    public Score2AndBalance(Swerve swerve, Collector collector, PIDExtender pidExtender, PIDPivot pidPivot) {
        ...
        PathPlannerTrajectory Score2Left = PathPlanner.loadPath("Score2WIthNoBump", new PathConstraints(2.5, 2.5));
        PathPlannerTrajectory balance = PathPlanner.loadPath("Score2AndBalanceEnd", new PathConstraints(2.25, 2.25));
        ...
        // eventMap.put("ExtendIn1", Commands.runOnce(() -> pidExtender.setSetpointInches(0), pidExtender));
         ...
         eventMap.put("GroundCubeExtend", Commands.runOnce(() -> pidExtender.setSetpointInches(15)));
