...
public class RightScore2 extends PPAutoBase{

    public RightScore2(Swerve swerve, Collector collector, PIDExtender pidExtender, PIDPivot pidPivot) {
        super(swerve);

        PathPlannerTrajectory Score2Right = PathPlanner.loadPath("Score2Right", new PathConstraints(2.0, 2.0));
