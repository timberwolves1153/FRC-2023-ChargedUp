...
//     private final String Test = "pathplanner/generatedJSON/TestPath2.wpilib.json";
...
//         Path path3 = Filesystem.getDeployDirectory().toPath().resolve(Test);
//         try {
//             trajectory = TrajectoryUtil.fromPathweaverJson(path);
//             trajectory2 = TrajectoryUtil.fromPathweaverJson(path2);
//             trajectory3 = TrajectoryUtil.fromPathweaverJson(path3);
//         } catch (IOException e) {
//             trajectory = null;
//             trajectory2 = null;
//             trajectory3 = null;
