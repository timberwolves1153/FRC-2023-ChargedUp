...
public class RightScore2AndBalance extends PPAutoBase{

    public RightScore2AndBalance(Swerve swerve, Collector collector, PIDExtender pidExtender, PIDPivot pidPivot) {
        super(swerve);

        PathPlannerTrajectory Score2andBalanceRight = PathPlanner.loadPath("Score2RightBalanceRight", new PathConstraints(2.0, 2.0));
        ...
        FollowPathWithEvents command = new FollowPathWithEvents(followTrajectoryCommand(Score2andBalanceRight, true), Score2andBalanceRight.getMarkers(), eventMap);
